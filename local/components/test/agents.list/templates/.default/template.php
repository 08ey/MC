                ...
                <div class="agent__card_item">
                    <div class="agent__card_info">
                        ...
                        <div class="card__info_item">
                            ...
                            <div class="name"><?=$arItem["UF_PHONE_NUMBER"];?></div>
                        </div>
                        <div class="card__info_item">
                            <div class="position"><?=GetMessage("ACTIVITY");?></div>
                            <div class="name"><?=$arItem["UF_TYPE_OF_ACT"];?></div>
                        </div>
                    </div>
                </div>
		<a class="star <?if(is_array( $arResult["STAR_AGENTS"])&&in_array($arItem["ID"], $arResult["STAR_AGENTS"])){echo("active");}?>" data-id="<?=$arItem["ID"]?>">
